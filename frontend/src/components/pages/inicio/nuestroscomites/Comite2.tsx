  ...
  return (
    <svg className={cn('w-full max-w-64', className)} viewBox="0 0 253 168" fill="none" xmlns="http://www.w3.org/2000/svg">
      <g clip-path="url(#clip0_16_139)">
        ...
        <path d="M105.417 208.05V133L22.1375 86.45" stroke="#45D6E4" strokeWidth="12" stroke-linecap="round" strokeLinejoin="round" />
        <path d="M105.417 133L230.862 67.45" stroke="#45D6E4" strokeWidth="12" stroke-linecap="round" strokeLinejoin="round" />
        <path d="M147.583 188.1V111.15" stroke="#45D6E4" strokeWidth="12" stroke-linecap="round" strokeLinejoin="round" />
        <path d="M189.75 166.25V89.3" stroke="#45D6E4" strokeWidth="12" stroke-linecap="round" strokeLinejoin="round" />
      </g>
    </svg>
